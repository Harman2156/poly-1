...
const ABI = require("../artifacts/contracts/harman.sol/harman.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("harman");
  const nft = await NFT.attach(" 0x0c2EA56b2dcEE9cc2b0bA8187d004C560cbC3cA9");
